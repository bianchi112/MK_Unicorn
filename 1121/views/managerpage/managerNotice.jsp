						...
						<div class="orderbar_item">
							...
							<table>
								...
								<c:forEach var="noticedto" items="${data.list}">
									<tr id="products">
										<td class="table_produtNo" >${noticedto.noticeNo}</td>
										<td class="table_productName">${noticedto.noticeTitle}</td>
										<td class="table_productPrice">${noticedto.noticeDate}</td>
										<td class=""><input type="checkbox" name="productNo" value="${noticedto.noticeNo}"></td>
									</tr>
								</c:forEach>
							</table>
