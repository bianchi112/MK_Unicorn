...
<head>
  ...
  <style>
    ...
    .mypage2 { font-size: 25px; text-align: center; margin-top: 20px; }
    ...
    .mainbar_item { border: 1px solid rgb(179, 178, 178); border-radius: 10px; width: 400px; height: 150px; }
...
<!--           </table> -->
        ...
        <div class="orderbar">
          ...
          <div class="orderbar_item">
            ...
            <div class="order_detail"><a href="orderlist">자세히보기</a></div>
            <table>
              <tr>
