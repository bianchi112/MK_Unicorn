...
//        	List<PaymentDTO> list = (List<PaymentDTO>) session.getAttribute("list3");
// 		if(list == null) {
										...
										<table class="table" class="receiverinfo">
											...
											<tr class="orderedProduct">
												<th scope="row" rowspan="3"><a href="product.jsp">
														<img src="${cart.mainimg1 }" width="180px"
											...
											<tr>
												<td class="inputcontent">
													<div class="productquantity">
														수량 <span class="quantity-item">
														${cart.cartcount } 
<%-- 														<%=numberFormat.format(beforePay.getAmount() )%> --%>
														</span>개
													</div>
												</td>
											<tr style="border: none;">
												<td class="inputcontent">
													<div class="productprice">
														<span class="productprice-item">
<%-- 														<%=numberFormat.format(beforePay.getProductPrice()) %> --%>
														</span>원
													</div>
												</td>
											</tr>
								...
								<div class="deleverystyle">
									<div class="deleveryPrice">
										...
										<div class="deleveryFee-item">
											<span class="delveryFee"><strong> 
<%-- 											<%=numberFormat.format(list.get(0).getDeleveryFee())%> --%>
											</span>
											원</strong>
										</div>
									</div>
...
<%-- 														<%=numberFormat.format( list.get(0).getProductPrice()) %> --%>
														원</a>
													</td>
												</tr>
												<tr>
								...
								<div class="totalReserveMoneystyle">
									<div class="totalReserveMoney">
										...
										<div class="totalReserveMoney-item">
											<span class="totalReserveMoney</strong>"><strong> 0원 </strong></span>
										</div>
									</div>
								</div>
